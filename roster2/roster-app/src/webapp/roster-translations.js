...
// NYU Customisations
title_msg="To add or remove participants from the site, visit the Settings tool.";
title_msg_groups="To add or remove participants from groups, visit the Settings tool.";
